      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            My professional journey and roles where I've contributed my skills and expertise.
          </p>
        </div>
                ...
                <div className={`flex flex-col md:flex-row items-center`}>
                  ...
                  <div className="md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
                    <div className="relative">
                      ...
                      <div className={`bg-gray-100 p-4 rounded-lg shadow-sm max-w-md transition-transform hover:scale-105 duration-300 ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'}`}>
